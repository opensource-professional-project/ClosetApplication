...
public class CapAdapter extends RecyclerView.Adapter<CapAdapter.MainViewHolder> {
    ...
    public CapAdapter(Activity activity, ArrayList<PostInfo> myDataset) {
        this.mDataset = myDataset;
        this.activity = activity;

        capHelper = new CapHelper(activity);
    }

    public void setOnPostListener(OnPostListener onPostListener){
        capHelper.setOnPostListener(onPostListener);
    }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.modify:
                        myStartActivity(WriteCapActivity.class, mDataset.get(position));
                        return true;
                    case R.id.delete:
                        capHelper.storageDelete(mDataset.get(position));
                        return true;
                    default:
                        return false;
                }
